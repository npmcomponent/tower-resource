...
exports.get = function(name){
  if (undefined === this.attrs[name] && this.constructor.attrs.__default__.hasOwnProperty(name))
    // XXX: refactor
    return this.attrs[name] = this.constructor.attrs.__default__[name].apply(this);
  else
